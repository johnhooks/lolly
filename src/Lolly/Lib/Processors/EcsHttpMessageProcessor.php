...
use Lolly\Psr\Http\Message\{MessageInterface, RequestInterface, ResponseInterface, UriInterface};
 ...
 *
 * @link https://www.elastic.co/guide/en/ecs/current/ecs-http
 * @link https://www.elastic.co/guide/en/ecs/current/ecs-url
